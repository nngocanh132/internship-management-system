...
$title_map  = ['profile'=>'Hồ sơ','internship'=>'Vị trí Thực tập','application'=>'Đơn ứng tuyển',
               ...
               'admin'=>'Tổng quan','student'=>'Tổng quan','dashboard'=>'Tổng quan'];
...
<div class="sidebar">
  ...
  <div class="sb-top">
    ...
    <div class="nav-sec">
      ...
      <a href="<?=$base?>/dashboard/admin.php"   class="nav-a <?=_isActive('/dashboard/admin')?>"><i class="bi bi-speedometer2"></i> Tổng quan</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Quản lý hệ thống</div>
      <a href="<?=$base?>/users/list.php"                class="nav-a <?=_isActive('/users/')?>"><i class="bi bi-people-fill"></i> Người dùng</a>
      <a href="<?=$base?>/student_profiles/list.php"     class="nav-a <?=_isActive('/student_profiles/')?>"><i class="bi bi-mortarboard-fill"></i> Hồ sơ Sinh viên</a>
      <a href="<?=$base?>/company_profiles/list.php"     class="nav-a <?=_isActive('/company_profiles/')?>"><i class="bi bi-building-fill"></i> Hồ sơ DN</a>
      <a href="<?=$base?>/lecturer_profiles/list.php"    class="nav-a <?=_isActive('/lecturer_profiles/')?>"><i class="bi bi-person-workspace"></i> Giảng viên</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Thực tập</div>
      <a href="<?=$base?>/internships/list.php"          class="nav-a <?=_isActive('/internships/')?>"><i class="bi bi-briefcase-fill"></i> Vị trí thực tập</a>
      <a href="<?=$base?>/applications/list.php"         class="nav-a <?=_isActive('/applications/')?>"><i class="bi bi-clipboard-check-fill"></i> Xét duyệt đơn</a>
      <a href="<?=$base?>/registrations/list.php"        class="nav-a <?=_isActive('/registrations/list')?>"><i class="bi bi-journal-richtext"></i> Đang thực tập</a>
      <a href="<?=$base?>/registrations/assign.php" class="nav-a <?=_isActive('/registrations/assign')?>"><i class="bi bi-person-check-fill"></i> Phân công GVHD</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Kết quả</div>
      <a href="<?=$base?>/evaluations/list.php"          class="nav-a <?=_isActive('/evaluations/')?>"><i class="bi bi-star-fill"></i> Đánh giá</a>
      <a href="<?=$base?>/reports/list.php"              class="nav-a <?=_isActive('/reports/')?>"><i class="bi bi-file-earmark-text-fill"></i> Báo cáo TT</a>
    </div>

    <?php elseif($role==='student'): ?>
    <div class="nav-sec">
      <div class="nav-label">Sinh viên</div>
      <a href="<?=$base?>/dashboard/student.php" class="nav-a <?=_isActive('/dashboard/student')?>"><i class="bi bi-speedometer2"></i> Tổng quan</a>
      <a href="<?=$base?>/student_profiles/edit.php" class="nav-a <?=_isActive('/student_profiles/edit')?>"><i class="bi bi-person-circle"></i> Hồ sơ của tôi</a>
      <a href="<?=$base?>/internships/browse.php" class="nav-a <?=_isActive('/internships/browse')?>"><i class="bi bi-search"></i> Tìm việc thực tập</a>
      <a href="<?=$base?>/applications/my_applications.php" class="nav-a <?=_isActive('/applications/my')?>"><i class="bi bi-clipboard-check-fill"></i> Đơn ứng tuyển</a>
      <a href="<?=$base?>/registrations/my_internship.php" class="nav-a <?=_isActive('/registrations/my')?>"><i class="bi bi-briefcase-fill"></i> Thực tập của tôi</a>
      <a href="<?=$base?>/reports/submit.php" class="nav-a <?=_isActive('/reports/submit')?>"><i class="bi bi-file-earmark-arrow-up-fill"></i> Nộp báo cáo</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Liên lạc</div>
      <a href="<?=$base?>/messages/inbox.php" class="nav-a <?=_isActive('/messages/inbox')?>">
        <i class="bi bi-chat-dots-fill"></i> Tin nhắn với DN
        <?php if($unread>0): ?><span class="msg-badge"><?=$unread?></span><?php endif; ?>
      </a>
      <a href="<?=$base?>/messages/lecturer_chat.php" class="nav-a <?=_isActive('/messages/lecturer_chat')?>">
    ...
    <div class="nav-sec">
      ...
      <a href="<?=$base?>/dashboard/company.php" class="nav-a <?=_isActive('/dashboard/company')?>"><i class="bi bi-speedometer2"></i> Tổng quan</a>
      <a href="<?=$base?>/company_profiles/edit.php" class="nav-a <?=_isActive('/company_profiles/edit')?>"><i class="bi bi-building-fill"></i> Hồ sơ DN</a>
      <a href="<?=$base?>/internships/my_jobs.php" class="nav-a <?=_isActive('/internships/my_jobs')?>"><i class="bi bi-briefcase-fill"></i> Vị trí Thực tập</a>
      <a href="<?=$base?>/applications/company_candidates.php" class="nav-a <?=_isActive('/applications/company_candidates')?>"><i class="bi bi-people-fill"></i> Danh sách Ứng viên</a>
      <a href="<?=$base?>/evaluations/add.php" class="nav-a <?=_isActive('/evaluations/')?>"><i class="bi bi-star-fill"></i> Đánh giá SV</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Liên lạc</div>
      <a href="<?=$base?>/messages/inbox.php" class="nav-a <?=_isActive('/messages/')?>">
    ...
    <div class="nav-sec">
      ...
      <a href="<?=$base?>/dashboard/lecturer.php" class="nav-a <?=_isActive('/dashboard/lecturer')?>"><i class="bi bi-speedometer2"></i> Tổng quan</a>
      <a href="<?=$base?>/registrations/my_students.php" class="nav-a <?=_isActive('/registrations/my_students')?>"><i class="bi bi-people-fill"></i> SV được phân công</a>
      <a href="<?=$base?>/reports/review.php" class="nav-a <?=_isActive('/reports/review')?>"><i class="bi bi-file-earmark-check-fill"></i> Duyệt báo cáo</a>
    </div>
    <div class="nav-sec">
      <div class="nav-label">Liên lạc</div>
      <a href="<?=$base?>/messages/lecturer_chat.php" class="nav-a <?=_isActive('/messages/lecturer_chat')?>">
