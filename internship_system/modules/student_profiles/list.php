...
$sql = "SELECT sp.*,u.email,u.is_profile_completed,u.created_at
...
<div class="ph fu">
  <div><h4><i class="bi bi-people-fill me-2"></i>Hồ sơ Sinh viên</h4><div class="ph-sub">Tổng: <?=count($students)?></div></div>
</div>
<?php showFlash(); ?>
...
<div class="card tc fu2"><div class="card-body p-0">
  <table class="table mb-0">
    <thead><tr><th>#</th><th>Sinh viên</th><th>Email</th><th>Mã SV</th><th>Chuyên ngành</th><th class="text-center">GPA</th><th>Ngày đăng ký</th><th>Hồ sơ</th></tr></thead>
    <tbody>
    ...
    <tr>
      ...
      <td><span class="badge" style="<?=$s['is_profile_completed']?'background:rgba(74,158,106,.12);color:#2d6a40':'background:rgba(196,154,108,.12);color:#a07040'?>"><?=$s['is_profile_completed']?'✅ Hoàn thiện':'⚠️ Chưa xong'?></span></td>
    </tr>
