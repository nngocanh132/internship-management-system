...
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    $stmt = $conn->prepare("DELETE FROM lecturer_evaluations WHERE eval_id=?");
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4><i class="bi bi-star-half me-2 text-primary"></i>Đánh giá từ Giảng viên</h4>
        ...
        <table class="table table-hover table-bordered mb-0">
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="text-center"><?= number_format($e['report_score'], 1) ?></td>
                    <td class="text-center"><?= number_format($e['journal_score'], 1) ?></td>
                    <td class="text-center"><?= number_format($e['presentation_score'], 1) ?></td>
