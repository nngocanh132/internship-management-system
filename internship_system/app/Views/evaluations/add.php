<?php // View: evaluations/add — nhận $pending, $errors từ controller ?>
    ...
    <div class="card fu1"><div class="card-body">
      <form method="POST"><div class="row g-3">
        ...
        <div class="col-12">
          ...
          <textarea name="comment" class="form-control" rows="4" placeholder="Nhận xét về thái độ, năng lực, sự tiến bộ..."><?=htmlspecialchars($_POST['comment']??'')?></textarea>
        </div>
      </div>
      <hr>
